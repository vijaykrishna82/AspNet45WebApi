...
namespace EventWebApi.PactConsumer.Tests
{
    public class EventsApiConsumerTests :  IUseFixture<ConsumerEventApiPact>
    {
        ...
        {
            //Arrange
            MockProviderService.Given("there are events with ids '45D80D13-D5A2-48D7-8353-CBB4C0EAABF5', '83F9262F-28F1-4703-AB1A-8CFD9E8249C9' and '3E83A96B-2A0C-49B1-9959-26DF23F83AEB'")
            ...
            var consumer = new EventsApiClient(MockProviderServiceBaseUri);
        ...
        public void GetAllEvents_WhenCalled_ReturnsAllEvents()
        {
            ...
            var consumer = new EventsApiClient(MockProviderServiceBaseUri, testAuthToken);
        ...
        public void CreateEvent_WhenCalledWithEvent_Succeeds()
        {
            ...
            MockProviderService.UponReceiving("a request to create a new event")
                .With(new ProviderServiceRequest
                {
        ...
        {
            //Arrange
            MockProviderService.UponReceiving("a request to check the api status")
                .With(new ProviderServiceRequest
                {
                    Method = HttpVerb.Get,
            ...
            var consumer = new StatsApiClient(MockProviderServiceBaseUri);
        ...
        public void GetEventById_WhenTheEventExists_ReturnsEvent()
        {
            ...
            MockProviderService.Given(String.Format("there is an event with id '{0}'", eventId))
        ...
        public void GetEventsByType_WhenOneEventWithTheTypeExists_ReturnsEvent()
        {
            ...
            MockProviderService.Given(String.Format("there is one event with type '{0}'", eventType))
